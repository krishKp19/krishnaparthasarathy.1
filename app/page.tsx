...
import FadeIn from "../components/FadeIn"; // Import our new animation component
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-16 md:py-20">
        ...
        <FadeIn delay={0.3}>
          <p className="text-base md:text-xl text-slate-700 max-w-4xl mx-auto font-medium leading-relaxed">
            Product-focused professional with a strong foundation in infrastructure and platform reliability | ex-Amazon | Building reliable systems and improving cost efficiency across teams.
          </p>
        </FadeIn>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-14 gap-y-10 w-full mb-4">
            {expertise.map((section, index) => (
              /* Notice the index * 0.15 delay to stagger the cards */
